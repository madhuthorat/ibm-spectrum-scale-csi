...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CSIScaleOperatorNodeSpec) DeepCopyInto(out *CSIScaleOperatorNodeSpec) {
	*out = *in
	if in.Affinity != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSIScaleOperatorNodeSpec.
func (in *CSIScaleOperatorNodeSpec) DeepCopy() *CSIScaleOperatorNodeSpec {
	if in == nil {
		return nil
	}
	out := new(CSIScaleOperatorNodeSpec)
	in.DeepCopyInto(out)
	return out
}
