...
//func NewCSIControllerSyncer(c client.Client, scheme *runtime.Scheme, driver *csiscaleoperator.CSIScaleOperator) syncer.Interface {
func NewCSIControllerSyncer(c client.Client, scheme *runtime.Scheme, driver *csiscaleoperator.CSIScaleOperator) syncer.Interface {
...
func (s *csiControllerSyncer) ensureContainersSpec() []corev1.Container {
	...
	controllerPlugin.ImagePullPolicy = "Always"
	...
	provisioner.ImagePullPolicy = "Always"
